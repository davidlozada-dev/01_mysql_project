...
Also, after sketching all the relational database schemas with the designing tool __Dia__, to make this development more interesting all the SQL statements are created and run in the __MySQL Command-Line__, and the resulting database is exported as a SQL file with __HeidiSQL__.
